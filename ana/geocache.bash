...
Use the current CSGOptiX render/simtrace scripts for target visualization.

EON
}


geocache-rendering-notes(){ cat << EON
Legacy geocache rendering and GPU sweep helpers have been removed.
Use the CSGOptiX render/simtrace scripts for current workflows.
EON
}
