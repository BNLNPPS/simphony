...
$
    ...
    while (std::getline(ss, line, '\n'))
    {
        ...
        std::cout << std::setw(60) << line << " : " << std::setw(60) << path << std::endl;
    }
}
...
void test_Basename()
{
    ...
    for (unsigned i = 0; i < paths.size(); i++)
    {
        ...
        std::cout << " path [" << path << "]" << " base [" << base << "]" << std::endl;
    }
}
...
void test_Basename_2()
{
    ...
    LOG(info) << std::endl << " path [" << path << "]" << std::endl << " base [" << base << "]" << std::endl;
...
$RNGDir
    ...
    while (std::getline(ss, line, '\n'))
    {
        ...
        for (int idx = -2; idx <= 2; idx++)
        {
            ...
            std::cout << " idx " << std::setw(3) << idx << " line " << std::setw(60) << line << " : " << std::setw(60)
                      << path << std::endl;
        }
    }
}
...
void test_MakeEmpty()
{
    ...
    LOG(info) << " path " << path << " exists_0 " << exists_0 << " exists_1 " << exists_1;
}
...
void test_Remove()
{
    ...
    bool exists_1 = SPath::Exists(path);
    LOG(info) << " path " << path << " rc " << rc << " exists_0 " << exists_0 << " exists_1 " << exists_1;
}
...
void test_SearchDirUpTreeWithFile()
{
    ...
    LOG(info) << " startdir " << startdir << " relf " << relf << " cfbase " << cfbase;
}
