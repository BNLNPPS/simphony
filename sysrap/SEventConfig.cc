...
int SEventConfig::_SerInterval = ssys::getenvint(kSerInterval, _SerIntervalDefault ) ;
int SEventConfig::_SerHint = ssys::getenvint(kSerHint, _SerHintDefault ) ;
...
int SEventConfig::SerInterval(){ return _SerInterval ; }
int SEventConfig::SerHint(){     return _SerHint ; }
...
void SEventConfig::SetSerInterval(int ser_interval){ _SerInterval = ser_interval ; }
void SEventConfig::SetSerHint(int ser_hint){         _SerHint = ser_hint ; }
